...
import type { NovaEvents } from '@/domain/entities/core/NovaEvents'
import type { NovaDebug } from '@/domain/entities/app/NovaDebug'
...
import type { NovaRenderQueueSnapshot } from '@/domain/entities/graphics/NovaRenderQueueRenderer'
